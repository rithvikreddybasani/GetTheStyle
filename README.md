...
GetTheStyle is an open-source alternative to CSSPro, offering an intuitive and powerful way to inspect, edit, and experiment with CSS on any webpage directly from your browser.
...
- GetTheStyle will now be added as a Chrome extension.

## 🛠️ Usage

1. Install GetTheStyle as a browser extension.

2. Open any webpage and activate GetTheStyle from the browser toolbar.
